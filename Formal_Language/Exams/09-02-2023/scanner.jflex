...
token1 = ( (\%\*) | (\*\%) | (\%\%) ){6,17} {hexnum} ((\+{hexnum}){2} | (\+{hexnum}){5})
hexnum = ({hex}{2}) | ({hex}{3}) | ({hex}{6})
token2 = {date} ([\$\%]{date}){2}(\-{bin})?
date = (2022\/11\/1[5-9]) | (2022\/11\/2[0-9]) | (2022\/11\/30) | (2022\/12\/[02][0-9]) | (2022\/12\/1[0-24-9]) | (2022\/12\/3[01]) |
	   (2023\/0[13]\/[0-2][0-9]) | (2023\/01\/3[01]) | (2023\/03\/30) | (2023\/02\/0[0-9]) | (2023\/02\/1[0-35-9]) | (2023\/02\/2[0-8])
bin = (1011) | (11[01][01]) | (10[01][01][01])
...
"EURO/kg" 			{if(test)System.out.print(yytext());return sym(sym.KGW);} 
"kg" 			{if(test)System.out.print(yytext());return sym(sym.KW);} 
