...
// doubleExpNotation = (([0-9]+\.[0-9]*) | ([0-9]*\.[0-9]+)) (e|E('+'|'-')?[0-9]+)?
 email =	([a-zA-Z0-9_\.])+"@"([a-zA-Z])+("."("it"|"org"|"com"|"net"))+
...
uppercase = [A-Z]
lowercase = [a-z]
octal = ("-"([1-7]|[1-7][0-7]|1[0-2][0-7]))
		|0|
		[1-7] | [1-7][0-7] |[1-2][0-7][0-7] |3[0-1][0-7] |32[0-3] 
words = "xx"| "yy" | "zz"
...
"T" 				{if(test)System.out.print(yytext());return sym(sym.T,Boolean.TRUE);} 
"F" 				{if(test)System.out.print(yytext());return sym(sym.F,Boolean.FALSE);} 
...
{uppercase}			{if(test)System.out.print(yytext());return sym(sym.UPPERCASE);}
{lowercase}			{if(test)System.out.print(yytext());return sym(sym.LOWERCASE);}  
{words} 			{if(test)System.out.print(yytext());return sym(sym.WORDS);} 
"CMP" 				{if(test)System.out.print(yytext());return sym(sym.CMP);} 
"WITH" 				{if(test)System.out.print(yytext());return sym(sym.WITH);} 
