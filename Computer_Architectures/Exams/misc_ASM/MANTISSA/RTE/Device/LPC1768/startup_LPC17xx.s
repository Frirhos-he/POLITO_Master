...
;1.	take the mantissa of the two parameters
     ;R2 MANTISSA0    R4 EXPO0     R3 MANTISSA1   R5EXPO1
	 ;R6 MANTIS_GENERATOR=0X7FFFFF
	 ;R7 EXPO_GENERATOR=0X7F800000 THEN SHIFT 23 BIT TO RIGHT
	 
	 LDR R6,=0X7FFFFF
	 AND R2,R0,R6; MANTIS0
	 AND R3,R1,R6; MANTIS1
...
;b)	shift right the mantissa of the number with the lower exponent by as many position as the difference between the two exponents.
	 
	 ;EXPONENT OF RESULT IS R9     
	 CMP R4,R5
     MOVGE R9,R4
	 BEQ   STEP4
     SUBGT R10,R4,R5
