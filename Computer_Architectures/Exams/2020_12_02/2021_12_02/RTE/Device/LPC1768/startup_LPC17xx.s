...
computeDifferences PROC
	...
	MOV r4,r1 ; n+1 counter
	MOV r11,#0 ;counter increment
loopc
	SUB r4,r4,#1
	CMP r4,#0
	BEQ over
...
;If the result of the subtraction is negative but it is too small to fit in 32 bits, then it is replaced with the smallest negative value that you can store in 32 b	
